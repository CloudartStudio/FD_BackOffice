    ...
    <>
      {_session && (
        <div className={style.avatar_section}>
          ...
          >
            {_session.user.email.ID_ruolo === 1 && _session.user.email.admin && (
              <span>{_session.user.email.admin.email[0]}</span>
            )}
            {_session.user.email.ID_ruolo === 3 && _session.user.email.partener && (
              <span>{_session.user.email.partener.email[0]}</span>
            )}
          </div>
