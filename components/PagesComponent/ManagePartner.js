...
import TablePartner from "../../components/table/TablePartner";
import fetch from "node-fetch";
import style from "../../styles/table.module.css";
import { useSession } from "next-auth/react";
import { useRouter } from "next/router";

export default function ManagePartner({ isPreview = false }) {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            const response = await fetch("http://localhost:3000/api/auth/account/partner");
