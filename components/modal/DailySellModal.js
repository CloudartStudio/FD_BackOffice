      ...
      {isOpen && (
        <div className={style.Modal}>
          ...
          <div className={style.ModalBody}>
            <div className={style.ModalBodyLabelContainer}>
              ...
              <div className={style.ModalField}>
                <label>Data</label>
                <br />
                <input type={"date"} placeholder="Data..." name="data" onChange={handleOnChangeForm} value={dailySell.data_vendita}></input>
              ...
              <div className={style.ModalField}>
                ...
                <br />
                <input type={"text"} placeholder="Totale Incasso..." name="totale_incasso" onChange={handleOnChangeForm} value={dailySell.totale_incasso}></input>
                {errors.totale_incasso && (<p className={style.error}>{errors.totale_incasso}</p>)}
              </div>
            </div>
            ...
            <div className={style.ModalBodyLabelContainer}>
              ...
              <div className={style.ModalField}>
                ...
                <br />
                <input type={"text"} placeholder="Totale Numero Vendite..." name="totale_numero_vendite" onChange={handleOnChangeForm} value={dailySell.totale_numero_vendite}></input>
                {errors.totale_numero_vendite && (<p className={style.error}>{errors.totale_numero_vendite}</p>)}
              </div>
              ...
              <div className={style.ModalField}>
                <label>Note</label>
                <br />
                <input type={"text"} placeholder="Note..." name="note" onChange={handleOnChangeForm} value={dailySell.note}></input>
          ...
          <div className={style.ModalFoot}>
            <button className={style.Success} onClick={() => {submitForm()}}>INVIA</button>
          </div>
        </div>
      )}
    </>
