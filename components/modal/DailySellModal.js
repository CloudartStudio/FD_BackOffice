    ...
    const submitForm = () => {
        try {
            ...
            Object.keys(dailySell).forEach((item) => {
                if (!handleValidationOnChange({ name: item, value: dailySell[item] }, true)) {
                    isValid = false;
                }
            });
            if (isValid) {
                ...
                <div className={style.ModalBody}>
                    ...
                    <div className={style.ModalBodyLabelContainer}>
                        ...
                        <div className={style.ModalField}>
                            <label>Note</label>
                            <br />
                            <textarea type={"text"} placeholder="Note..." name="note" onChange={handleOnChangeForm} value={dailySell.note}></textarea>
