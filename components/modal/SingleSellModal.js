        ...
        <div className={style.Modal}>
          ...
          <div className={style.ModalBody}>
            ...
            <div className={style.ModalField}>
              ...
              <br />
              <input type={"text"} placeholder="Data Vendita..." name="ID_cliente" onChange={handleOnChangeForm} value={singleSell.ID_cliente}></input>
            </div>
            {/* data_vendita */}
            <div className={style.ModalField}>
              <label>Data Vendita</label>
              <br />
              <input type={"date"} placeholder="Data Vendita..." name="data_vendita" onChange={handleOnChangeForm} value={singleSell.data_vendita}></input>
            </div>  
            ...
            <div className={style.ModalField}>
              <label>Prezzo</label>
              <br />
              <input type={"text"} placeholder="Pre..." name="prezzo" onChange={handleOnChangeForm} value={singleSell.prezzo}></input>
            </div>
            ...
            <div className={style.ModalField}>
              <label>Note</label>
              <br />
              <input type={"text"} placeholder="Note..." name="note" onChange={handleOnChangeForm} value={singleSell.note}></input>
            </div>
