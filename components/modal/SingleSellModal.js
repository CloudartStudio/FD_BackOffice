      ...
      Object.keys(singleSell).forEach((item) => {
        if (
          !handleValidationOnChange(
            { name: item, value: singleSell[item] },
            true
          )
        ) {
          isValid = false;
          ...
          <div className={style.ModalBody}>
            <div className={style.ModalBodyLabelContainer}>
              ...
              <div className={style.ModalField}>
                ...
                ></input>
                {errors.ID_cliente && (
                  <p className={style.error}>{errors.ID_cliente}</p>
                )}
              </div>
              {/* data_vendita */}
              <div className={style.ModalField}>
                ...
                ></input>
                {errors.data_vendita && (
                  <p className={style.error}>{errors.data_vendita}</p>
                )}
              </div>
            </div>
            ...
            <div className={style.ModalBodyLabelContainer}>
              ...
              <div className={style.ModalField}>
                ...
                ></input>
                {errors.prezzo && (
                  <p className={style.error}>{errors.prezzo}</p>
                )}
              </div>
